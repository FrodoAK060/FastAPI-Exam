...
async def get_current_bayer(current_user: UserModel = Depends(get_current_user)):
    """
...
async def get_specific_users(*roles, current_user: UserModel = Depends(get_current_user)):
    """
...
async def get_current_bayer_or_admin(current_user: UserModel = Depends(get_current_user)):
    """
